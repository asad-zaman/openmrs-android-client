...
import org.intelehealth.app.mpower.activities.addeditpatient.AddEditPatientFragment;
import org.intelehealth.app.mpower.activities.addeditpatient.SimilarPatientsRecyclerViewAdapter;
import org.intelehealth.app.mpower.activities.patientdashboard.PatientDashboardActivity;
import org.intelehealth.app.mpower.activities.patientdashboard.visits.PatientVisitsFragment;
import org.intelehealth.app.mpower.activities.providerdashboard.ProviderDashboardActivity;
import org.intelehealth.app.mpower.activities.syncedpatients.SyncedPatientsActivity;
import org.intelehealth.app.mpower.activities.visitdashboard.VisitDashboardFragment;
...
import org.intelehealth.app.mpower.activities.login.LoginFragment;
import org.intelehealth.app.mpower.activities.patientdashboard.PatientDashboardActivity;
import org.intelehealth.app.mpower.activities.patientdashboard.visits.PatientVisitsFragment;
import org.intelehealth.app.mpower.activities.providerdashboard.ProviderDashboardActivity;
import org.intelehealth.app.mpower.activities.syncedpatients.SyncedPatientsActivity;
        ...
        return view -> {
            switch (action) {
                ...
                case MULTI_DELETE_PATIENT:
                    ...
                    ToastUtil.showShortToast(getContext(), ToastUtil.ToastType.SUCCESS, org.intelehealth.app.mpower.R.string.multiple_patients_deleted);
                    break;
                case SELECT_LOCATION:
                    OpenmrsAndroid.setLocation(locationListView.getAdapter().getItem(locationListView.getCheckedItemPosition()).toString());
                    ToastUtil.showShortToast(getContext(), ToastUtil.ToastType.SUCCESS, org.intelehealth.app.mpower.R.string.location_successfully_updated);
                    dismiss();
                    break;
