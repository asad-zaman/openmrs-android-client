...
import static org.intelehealth.app.mpower.iot.GlucoseMeasurementUnit.MiligramPerDeciliter;
import static org.intelehealth.app.mpower.iot.GlucoseMeasurementUnit.MmolPerLiter;
...
public class GlucoseMeasurement implements Serializable {
    ...
    public String toString() {
        ...
        return String.format(Locale.ENGLISH,"%.1f %s, at (%s)", value, unit == GlucoseMeasurementUnit.MmolPerLiter ? "mmol/L" : "mg/dL", formattedTimestamp);
    }
}