 ...
 */
package org.intelehealth.app.mpower.activities.visitdashboard
...
import org.intelehealth.app.mpower.databinding.FragmentVisitDashboardBinding
...
class VisitDashboardFragment : BaseFragment() {
    ...
    private fun setupAdapter() = with(binding) {
        ...
        visitDashboardExpList.setAdapter(
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.actionEndVisit -> CustomDialogBundle()
                .apply {
